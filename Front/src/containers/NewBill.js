...
export default class NewBill {
  ...
  handleChangeFile = e => {
    e.preventDefault();
    extensionFileValid = true;
    const fileSelected = this.document.querySelector(`input[data-testid="file"]`)
